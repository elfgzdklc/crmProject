...
//     const customerCategories = await axios.post(`${path}api/customer-management/customer-categories/get-customer-categories`, {
//         limit: 10,
//         page: 1,
//         sortColumn: 'id',
//         sortType: 'desc',
...
function CustomerCategories(props) {
    ...
    const handleCloseCustomerCategory = () => setShowCustomerCategory(false);
    const handleShowCustomerCategory = () => setShowCustomerCategory(true);
    ...
    async function getPermissionDetail() {
        ...
        await axios({
            ...
            setLoading(false)
            if (response.data[0] === undefined ||  response.data[0].customer_categories === 0) {
    ...
    async function getCustomerCategories() {
        ...
        await axios({
            method: 'post',
            url: '/api/customer-management/customer-categories/get-customer-categories',
            headers: {
                'Content-Type': 'application/json',
                AuthToken: props.token
            },
    ...
    const onSubmit = async (data) => {
        await axios({
            method: 'post',
            url: '/api/customer-management/customer-categories/add-edit-category',
            headers: {
                'Content-Type': 'application/json',
                AuthToken: props.token
            },
    ...
    const deleteCategory = async (id) => {
        ...
        deleteSwal(`/api/customer-management/customer-categories/delete-category/${id}`, getToken, () => {
            getCustomerCategories();
        });
    }
    ...
    return (
        <div>
            <Title title="Firma Kategorileri"/>
            <Breadcrumbs aria-label="breadcrumb" className="bg-white mb-3 p-3 rounded shadow">
                ...
                <Link
                    underline="none"
                    color="inherit"
                    href="/customerManagement/customerCategories"
                >
                    Firma Kategorileri
                </Link>
            </Breadcrumbs>
                        ...
                        <h5 className="fw-bold mb-0">
                            <Button variant="outlined" className="text-capitalize btn-tk"
                                    onClick={() => {
                                        reset()
                                        setValue("id", 0);
                                        handleShowCustomerCategory();
                                    }}>
                                <i className="fas fa-plus me-1"></i> Yeni Kategori
                            </Button>
                        </h5>
                    </div>
            ...
            <Modal show={showCustomerCategory} onHide={handleCloseCustomerCategory}>
                    ...
                    <Modal.Body>
                        <div className="row">
                            <div className="col-12 col-lg-12">
                                ...
                                <span className="registerTitle text-danger fw-bold m-1"> *</span>
                                <input type="text"
