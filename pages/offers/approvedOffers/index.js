...
//     const offers = await axios.post(`${path}api/offers/get-approved-offers`, {
//         limit: 10,
//         page: 1,
//         sortColumn: 'id',
//         sortType: 'desc',
...
function ApprovedOffers(props) {
    ...
    async function getPermissionDetail() {
        ...
        await axios({
            ...
            setLoading(false)
            if (response.data[0] === undefined || response.data[0].approved_offers === 0) {
    ...
    async function getOffers() {
        setLoading(true);
        await axios({
            method: 'POST', url: '/api/offers/get-approved-offers', headers: {
    ...
    async function getOffer(offer_id) {
        await axios({
            method: 'get', url: `/api/offers/get-offer/${offer_id}`, headers: {
                'Content-Type': 'application/json', AuthToken: props.token
            }
        }).then(function (response) {
    ...
    const createPDF = async (offer_id, bankDetails, pdfTitle) => {
        await axios({
            ...
            pdfDocument(response.data, settings, bankDetails, pdfTitle, `${pdfTitle}-${response.data.offer_code + "-" + (response.data.created_at).split("T")[0]}`).then(() => {
                Swal.close();
            });
        }).catch(function (error) {
            console.log(error)
    ...
    const onSubmit = async (data) => {
        if (data.products.length == 0) {
            alert('Uyarı!', 'Mevcut ürün olmadan revize işlemi yapılamaz!', 'warning', () => {
                getOffers()
            })
        } else {
            await axios({
    ...
    async function getSettings() {
        await axios({
            method: 'post', url: '/api/settings/get-settings', headers: {
                'Content-Type': 'application/json', AuthToken: props.token
            }
        }).then(function (response) {
    ...
    return (<div>
        <Title title="Onaylanmış Teklifler"/>
                                ...
                                {rowData => (<>
                                    <a className="cursor-pointer" title="Detay"
                                       onClick={() => {
                                           ...
                                           setValue('invoice_adress_id', rowData.invoice_id)
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Modal.Footer>
                    ...
                    <button type="button" className="p-2 btn-sm">
                        <i className="fal fa-check-circle"></i> Onaylandı
                    </button>
                </Modal.Footer>
            </form>
        </Modal>
        <Modal dialogClassName="my-modal" show={showRevised} onHide={handleCloseRevised} backdrop="static" keyboard={false}
               aria-labelledby="example-modal-sizes-title-xl">
            <Modal.Header closeButton>
                <label>Teklif Numarası: {getValues("offer_code")}{watch('revised_code') ? "-" + watch('revised_code') : ""}</label>
            </Modal.Header>
            <hr/>
                            ...
                            <div className="col-md-6 col-12">
                                <div className="row">
                                    ...
                                    <div className="col-6 col-lg-6 mb-2">
                                        ...
                                        {errors.shipment_address && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                    </div>
                                    <div className="col-12 col-lg-12 mb-2">
                                    ...
                                    <div className="row pe-0">
                                        <div className="col-4 col-lg-4 mb-2">
                                            ...
                                            {errors.shipped_by && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                        </div>
                                        <div className="col-4 col-lg-4 mb-2">
                                            ...
                                            {errors.delivery_term && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                        </div>
                                        <div className="col-4 col-lg-4 mb-2 pe-0">
                                            ...
                                            {errors.origin && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                        </div>
                                        <div className="col-4 col-lg-4 mb-2">
                                        ...
                                        <div className="col-4 col-lg-4 mb-2">
                                            ...
                                            {errors.type_of_packaging && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                        </div>
                                        <div className="col-4 col-lg-4 mb-2 pe-0">
                                            ...
                                            />
                                            {errors.validity && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-3 col-12">
                                <div className="row">
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <Controller
                                                    ...
                                                    rules={{required: true}}
                                                />
                                                {errors.delivery_time && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                            </div>
                                            <div className="col-md-6">
                                                <select
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <Controller
                                                    ...
                                                    rules={{required: true}}
                                                />
                                                {errors.maturity_time && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                            </div>
                                            <div className="col-md-6">
                                                <select
                                    ...
                                    <div className="col-6 col-lg-6 mb-2">
                                        ...
                                        {errors.payment && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                    </div>
                                    <div className="col-6 col-lg-6 mb-2">
                                        ...
                                        {errors.currency_unit && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                    </div>
                                    <div className="col-6 col-lg-6 mb-2">
                                        ...
                                        <Controller
                                            ...
                                            rules={{required: true}}
                                        />
                                        {errors.number_of_packages && <div className="invalid-feedback text-start">Bu alan zorunlu.</div>}
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-3 col-12">
                                <div className="row">
                                    <div className="col-12 col-lg-12 mb-3 pt-3 ">
                                        <Controller
                                            ...
                                            name="offer_date"
                                            render={({
                                                         field: {onChange, name, value}, fieldState: {error, invalid}
                                                ...
                                                <DatePicker
                                                    ...
                                                    renderInput={(params) => <TextField
                                                        ...
                                                        error={invalid}
                                                        inputProps={{
                                                            ...params.inputProps, placeholder: "__.__.____", readOnly: true
                                                        }}
                                                    />}
                                                />
                                        ...
                                        {fields.length > 0 ? (fields.map((item, index) => {
                                                        ...
                                                        <div className="col-md-8">
                                                            ...
                                                            >
                                                                ...
                                                                {getValues(`products.${index}.availability_time`) > 1 ? (
                                                                    <>
                                                                        <option value="Stock" selected={range == "Stock"}>Stokta</option>
                                                                        <option value="Days" selected={range == "Days"}>Gün</option>
                                                                        <option value="Weeks" selected={range == "Weeks"}>Hafta</option>
                                                                        <option value="Months" selected={range == "Months"}>Ay</option>
                                                                        <option value="Years" selected={range == "Years"}>Yıl</option>
                                                                    </>
                                                                ) : (
                                                                    <>
                                                                        <option value="Stock" selected={range == "Stock"}>Stokta</option>
                                                                        <option value="Day" selected={range == "Day"}>Gün</option>
                                                                        <option value="Week" selected={range == "Week"}>Hafta</option>
                                                                        <option value="Month" selected={range == "Month"}>Ay</option>
                                                                        <option value="Year" selected={range == "Year"}>Yıl</option>
                                                                    </>
                                            ...
                                            <th colSpan="12" className="text-center">
                                                <div className="alert alert-ks p-0 fade show mt-3 text-center" role="alert">
                                                    ...
                                                    }}><i className="fas fa-exclamation-circle"></i> Tümünü Geri Al!
                                                    </button>
                                                </div>
                                            </th>
                                        </tr>}
                                ...
                                <table className="table table-bordered">
                                    ...
                                    <tr style={{height: "100px"}}>
                                        ...
                                        <td colSpan="4" style={{width: "45%"}}>
                                            ...
                                            <div className="row ">
                                                <label className="col-sm-4 col-form-label fw-bold">USD IBAN
                                                    NO:</label>
                                                <div className="col-sm-8">
